...
namespace pstd {
	...
	PSTD_API Vec3 cross(const Vec3& a, const Vec3 b);
	...
	PSTD_API Rot3 calcRotor(Vec3 a, Vec3 b);  // from a to b

	PSTD_API Rot3 calcRotor(Vec3 a, Vec3 b, float radians);	 // from a to b
	...
	PSTD_API void rotate(Vec3* Vec, const Rot3& rotor);
	...
	PSTD_API Rot3 composeRotor(Rot3& a, Rot3& b);
